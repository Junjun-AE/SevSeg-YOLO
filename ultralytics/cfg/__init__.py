...
TASKS = frozenset({"detect", "segment", "classify", "pose", "obb", "score_detect"})
TASK2DATA = {
    "detect": "coco8.yaml",
    "score_detect": "coco8.yaml",
...
TASK2METRIC = {
    ...
    "score_detect": "metrics/mAP50-95(B)",
...
def check_dict_alignment(
    ...
    if allowed_custom_keys is None:
        allowed_custom_keys = {"augmentations", "save_dir", "score"}  # SevSeg-YOLO: score config dict
